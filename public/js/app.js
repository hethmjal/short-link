...
$(function () {
  ...
  $(".sign-up-btn").on("click", function (e) {
    ...
    if (errors == 0) {
      if ($("#ss").find("input").val() != "" && $("#ss").find("input").val().length > 4 && pass2.val() != pass.val()) {
  ...
  if (darkmode === "on") {
    ...
    $("#dark").find("i").addClass("bx-sun");
    $("#dark").find("i").removeClass("bx-moon");
  }
  ...
  $("#dark").on("click", function () {
    ...
    if (darkmode !== "on") {
      $("body").addClass("black");
      localStorage.setItem("darkmode", "on");
      $(this).find("i").addClass("bx-sun");
      $(this).find("i").removeClass("bx-moon");
    } else {
      $("body").removeClass("black");
      localStorage.setItem("darkmode", "off");
      $(this).find("i").addClass("bx-moon");
      $(this).find("i").removeClass("bx-sun");
    }
  });
